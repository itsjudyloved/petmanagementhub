...
function EditPet() {
  ...
  const { loading, error, getPet, updatePet } = usePetApi();
  ...
  const loadPet = async () => {
    try {
      ...
      setFormError('Failed to load pet data');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setFormError(err.message || 'Failed to update pet');
    }
  };
  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-purple-800 mb-8">Edit Pet</h1>
